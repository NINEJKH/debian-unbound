...
unbound ($(uscan --report-status --dehs "targets/${temp}" 2> /dev/null | xmlstarlet sel --template --value-of "/dehs/upstream-version")-${TRAVIS_BUILD_NUMBER}) ${temp}; urgency=medium
